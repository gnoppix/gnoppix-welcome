...
about-dialog-comments = Willkommensdialog für Gnoppix
...
outdated-version-warning = Du nutzt eine alte Version von Gnoppix, bitte downloade die letzte Version runter
...
welcome-title = Willkommen bei Gnoppix!
welcome-body =
    Danke, dass Sie sich unserer Community anschließen!

    Wir, die Gnoppix-Entwickler, hoffen, dass Sie es genauso sehr genießen werden Gnoppix zu benutzen, wie wir es genießen, es zu entwickeln. Die Links unten werden Ihnen helfen sich in Ihrem neuen Betriebssystem zurechtzufinden. Genießen Sie diese Erfahrung und zögern Sie nicht Ihr Feedback an uns zu senden.
